    ...
    <>
      <div className={styles.bori_goods_detail_info_container}>
        <div className={styles.goods_image_container}>
          ...
          <BoriGoodsDetailController goods={goods} user={user} />
        </div>
        <div className={styles.goods_info}>
          <p>제품 정보: {goods.bori_goods_name}</p>
          <p className={styles.goods_category}>카테고리: #{category.category_name}</p>
          <BoriGoodsDetailLike user={user} goods={goods} />
