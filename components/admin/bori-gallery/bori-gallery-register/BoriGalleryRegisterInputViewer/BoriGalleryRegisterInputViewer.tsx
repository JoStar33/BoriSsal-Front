  ...
  return (
    <>
      <div className={styles.text_container}>
        ...
        <input onChange={handleOnChangeGalleryInfo} name="bori_gallery_title" role="bori_gallery_title" id="goods-name" type="text" />
      </div>
      <div className={styles.content_container}>
        <p>갤러리 설명</p>
        <textarea onChange={handleOnChangeGalleryInfo} name="bori_gallery_desc" role="bori_gallery_desc" />
      </div>
    </>
  );
};
