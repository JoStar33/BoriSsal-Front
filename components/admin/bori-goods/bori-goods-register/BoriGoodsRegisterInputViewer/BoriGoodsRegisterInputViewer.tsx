  ...
  return (
    <>
      <div className={styles.text_container}>
        ...
        <input onChange={handleOnChangeGoodsInfo} name="bori_goods_name" role="bori_goods_name" id="goods-name" type="text" />
      </div>
      <div className={styles.text_container}>
        <label htmlFor="goods-price">굿즈가격:</label>
        <input onChange={handleOnChangeGoodsInfo} name="bori_goods_price" role="bori_goods_price" id="goods-price" type="number" />
      </div>
      <div className={styles.text_container}>
        <label htmlFor="goods-stock">재고량:</label>
        <input onChange={handleOnChangeGoodsInfo} name="bori_goods_stock" role="bori_goods_stock" id="goods-stock" type="number" />
      </div>
      ...
      <div className={styles.content_container}>
        <p>굿즈 설명</p>
        <textarea onChange={handleOnChangeGoodsInfo} name="bori_goods_desc" role="bori_goods_desc" />
      </div>
    </>
  );
};
