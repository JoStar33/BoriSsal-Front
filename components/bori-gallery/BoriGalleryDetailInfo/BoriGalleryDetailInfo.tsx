...
const BoriGalleryDetailLike = dynamic(() => import('../BoriGalleryDetailLike/BoriGalleryDetailLike'), { ssr: false });
    ...
    <>
      <div className={styles.bori_gallery_detail_info_container}>
        ...
        <div className={styles.gallery_info}>
          <BoriGalleryDetailLike gallery={gallery} user={user} />
          <ShareButton />
        </div>
        <p className={styles.gallery_description}>{gallery.bori_gallery_desc}</p>
      </div>
    </>
  );
};
