    ...
    <div className={styles.dialog_background}>
      <div className={styles.dialog_container}>
        ...
        <button
          ...
          onClick={() => handleUpdateStatus('배송준비')}
        >
          배송준비
        </button>
        <button
          aria-label="배송중"
          role="deliver-on"
          style={{ color: 'white', backgroundColor: '#5B59C1' }}
          onClick={() => handleUpdateStatus('배송중')}
        >
          배송중
        </button>
        <button
          aria-label="배송완료"
          role="deliver-over"
          style={{ color: 'white', backgroundColor: '#4DC667' }}
          onClick={() => handleUpdateStatus('배송완료')}
        >
          배송완료
        </button>
      </div>
