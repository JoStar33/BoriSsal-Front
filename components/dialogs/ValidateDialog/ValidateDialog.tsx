      ...
      {dialog && (
        <div className={styles.dialog_background}>
          <div className={styles.dialog_container}>
            ...
            <Image width={50} className={styles.dialog_bori} height={100} src={question_bori} alt="궁금한 보리" />
            <Image width={40} className={styles.dialog_question} height={40} src={question} alt="궁금해요" />
            <h2>{text}</h2>
          </div>
        </div>
      )}
